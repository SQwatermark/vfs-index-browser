                ...
                try
                {
                    switch (exportType)
                    {
                        ...
                        case ExportType.JSON:
                            ...
                            break;
                        case ExportType.ObjectJSON:
                            if (ExportObjectJSONFile(asset, exportPath))
                            {
                                exportedCount++;
                            }
                            break;
                        case ExportType.IdentifiedTexture:
                            if (ExportIdentifiedTexture(asset, exportPath))
                            {
                                exportedCount++;
                            }
                            break;
                        case ExportType.AnimationJSON:
                            if (asset.Asset is AnimationClip && ExportAnimationJSON(asset, exportPath))
                            {
                                exportedCount++;
                            }
                            break;
