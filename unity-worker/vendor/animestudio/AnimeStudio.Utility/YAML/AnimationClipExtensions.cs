...
namespace AnimeStudio
{
    public static class AnimationClipExtensions
    {
        ...
        public static string GetHumanoidPropertyName(this GenericBinding binding, bool isEndfield)
        {
            return isEndfield
                ? AnimationMuscleTypeExtensions.ToEndfieldAttributeString((int)binding.attribute)
                : binding.GetHumanoidMuscle().ToAttributeString();
        }
        #endregion
    }
