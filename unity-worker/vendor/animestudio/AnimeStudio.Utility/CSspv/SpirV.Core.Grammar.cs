...
namespace SpirV
{
    ...
    public class OpGroupNonUniformElect : Instruction
    {
        public OpGroupNonUniformElect() : base("OpGroupNonUniformElect", new List<Operand>()
    {new Operand(new IdResultType(), null, OperandQuantifier.Default), new Operand(new IdResult(), null, OperandQuantifier.Default), new Operand(new IdScope(), "Execution", OperandQuantifier.Default), })
        {
        }
    }
    public class OpGroupNonUniformBroadcastFirst : Instruction
    {
        public OpGroupNonUniformBroadcastFirst() : base("OpGroupNonUniformBroadcastFirst", new List<Operand>()
    {new Operand(new IdResultType(), null, OperandQuantifier.Default), new Operand(new IdResult(), null, OperandQuantifier.Default), new Operand(new IdScope(), "Execution", OperandQuantifier.Default), new Operand(new IdRef(), "Value", OperandQuantifier.Default), })
        {
        }
    }
    public class OpGroupNonUniformBitwiseOr : Instruction
    {
        public OpGroupNonUniformBitwiseOr() : base("OpGroupNonUniformBitwiseOr", new List<Operand>()
    ...
    public static class Instructions
    {
        ...
        static Instructions()
        {
            // The vendored grammar predates the SPIR-V 1.3 instructions used by Endfield.
            instructions_.Add(333, new OpGroupNonUniformElect());
            instructions_.Add(338, new OpGroupNonUniformBroadcastFirst());
            instructions_.Add(360, new OpGroupNonUniformBitwiseOr());
        }
